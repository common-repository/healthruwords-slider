=== Plugin Name ===
Contributors: healthruwords - https://healthruwords.com
Tags:  healthruwords slider,healthruwords,slider,widget,healthruwords widget for wordpress,healthruwords slider widget,live quotes, healthruwords 1.1, healthruwords 1.2, healthruwords api, quotes, inspirational quotes, inspirational pictures, inspirational images, motivational, inspirational, inspiring, empowering
...
Healthruwords Slider - Inspirational Quotes to empower people.
...
HealThruWords Slider Widget is a responsive slider widget that displays up to 20 Inspirational Quotes from https://HealThruWords.com.
...
= Plugin Features =
    ...
    *Display Inspirational Quotes through a configurable slider Widget.
...
If you like the plugin please Rate Us.
...
= 1.1 =
* Update the affiliate variable and sid 


= 1.2 =
* Added code to make the slider responsive
